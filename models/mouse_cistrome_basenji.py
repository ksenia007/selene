...
class MouseBasenji(nn.Module):

    def __init__(self, n_targets):
        super(MouseBasenji, self).__init__()
        ...
        self.conv6 = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.MaxPool1d(kernel_size=4, stride=4),  # this was changed
            nn.Dropout(p=0.05))
        ...
        self.final_conv = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Dropout(p=0.05))
        self.classifier = nn.Linear(1365, 16441)
